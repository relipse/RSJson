...
class RSJsonParser {
  ...
  void EatNextToken() {
    ...
    case '{':
      curToken.tokenType = rjtOPEN_BRACE;
      break;
    case '}':
      curToken.tokenType = rjtCLOSE_BRACE;
      break;
    case '[':
      curToken.tokenType = rjtOPEN_BRACKET;
      break;
    case ']':
      curToken.tokenType = rjtCLOSE_BRACKET;
      break;
    case ':':
      curToken.tokenType = rjtCOLON;
      break;
    case ',':
      curToken.tokenType = rjtCOMMA;
      break;
  ...
  void appendValueToLastOnStack(RSJsonBasic * ptrRSJsonBasic) {
    ...
    case rstArray:
      ...
      break;
    default:
      throw std::runtime_error("this should never happen. last object on stack is not a RSJsonObject or RSJsonArray");
    }
  }
  ...
  void js_value() {
    ...
    case rjtFLOAT:
      ...
      case rstArray:
        ...
        break;
      default:
        throw std::runtime_error("the object stack MUST contain RSJsonObject or RSJsonArray instance types! this should never occur");
      }
